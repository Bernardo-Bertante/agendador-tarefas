...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private final com.agendatarefa.agendador.infrastructure.security.JwtUtil jwtUtil;
    private final UserDetailsServiceImpl userDetailsService;

    // Construtor que inicializa as propriedades com instâncias fornecidas
    public JwtRequestFilter(com.agendatarefa.agendador.infrastructure.security.JwtUtil jwtUtil, UserDetailsServiceImpl userDetailsService) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                UserDetails userDetails = userDetailsService.loadUserByEmailAndToken(username, authorizationHeader);
                // Valida o token JWT
